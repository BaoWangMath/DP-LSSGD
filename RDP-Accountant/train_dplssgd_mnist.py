...
parser.add_argument('--LR-SGD', type=float, default=0.5, metavar='LR',
...
parser.add_argument('--SIGMA', type=float, default=0.0, metavar='LR', #0.0
                    help='The Laplacian smoothing constant')
...
def main():
    ...
    for epoch in range(args.EPOCH):
        ...
        inner_iter_num =10
        cur_train_loss, cur_test_loss= lssgd_dp(net, optimizer, train_loader,
                                                                 test_loader, loss_func,
                                                                 inner_iter_num, args, noise_multiplier, sigma=args.SIGMA)
